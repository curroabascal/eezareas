...
#' @export
checkfiles<-function(){
  eezfilename=system.file("extdata", "eezs.RDS", package = "eezareas")
  if (file.info(eezfilename)$size<10000000){
    file_url="https://github.com/curroabascal/eezareas/raw/refs/heads/master/inst/extdata/eezs.RDS?download="
